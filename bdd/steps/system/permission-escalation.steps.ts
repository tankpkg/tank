 ...
 * Feature: bdd/features/system/permission-escalation/escalation.feature
 *
 * Pure logic tests — no DB, no HTTP, no mocks.
 * Imports checkPermissionEscalation from @internals/helpers.
 */

import { checkPermissionEscalation, type EscalationResult, type VersionPermissions } from '@internals/helpers';
