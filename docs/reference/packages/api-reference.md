> Routes below exist in both `apps/web` (Next.js) and `apps/web-tanstack` (TanStack Start).
> TanStack routes live in `apps/web-tanstack/src/api/routes/`. For new work, use TanStack.
