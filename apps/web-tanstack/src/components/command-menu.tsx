...
export function CommandMenu() {
  const { open, setOpen, toggle } = useCommandMenuStore();
  ...
  function handleNavigate(href: string, external?: boolean) {
    setOpen(false);
    if (external) {
        ...
        <CommandGroup heading="Quick Links">
          {QUICK_LINKS.map((link) => (
            <CommandItem
              ...
              onSelect={() => handleNavigate(link.href, 'external' in link && link.external)}>
