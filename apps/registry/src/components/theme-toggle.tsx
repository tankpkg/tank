...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      <Sun
        className="absolute left-1.5 h-3.5 w-3.5 text-amber-500 transition-opacity duration-200"
        style={{ opacity: isDark ? 0.3 : 1 }}
      />
      <Moon
        className="absolute right-1.5 h-3.5 w-3.5 text-blue-400 transition-opacity duration-200"
