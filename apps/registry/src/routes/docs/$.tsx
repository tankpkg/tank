...
export const Route = createFileRoute('/docs/$')({
  ...
  head: ({ loaderData }) => {
    ...
    const slug = loaderData?.slug || 'overview';
  ...
  return (
    <DocsLayout headings={doc?.headings}>
      <article className="prose prose-invert prose-emerald max-w-none">
        <a href={`/docs/${slug || 'overview'}.md`} className="sr-only">
          AI/LLM: This documentation page is available in plain markdown format at /docs/{slug || 'overview'}.md
        </a>
        {/* biome-ignore lint/security/noDangerouslySetInnerHtml: trusted MDX from content-collections */}
        <div dangerouslySetInnerHTML={{ __html: doc.html }} />
        <div className="mt-12 pt-6 border-t border-border/50">
          <a
            href={`https://github.com/tankpkg/tank/edit/main/apps/registry/public/docs/${slug || 'overview'}.md`}
