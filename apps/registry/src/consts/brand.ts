export const GITHUB_REPO = 'tankpkg/tank';
...
export function getSelfhostedInstallMethods(appUrl: string) {
  return [
    { id: 'curl', label: 'curl', command: `curl -fsSL ${appUrl}/api/cli/install.sh | bash` },
    { id: 'direct', label: 'Direct Download', command: `${appUrl}/install-cli` }
  ];
}
