"""Stage 2: Language-specific static analyzers.

Contains the Python AST analyzer, Bandit integration, obfuscation detection,
and per-file analysis functions for Python, JS/TS, and shell scripts.
"""
...
class PythonASTAnalyzer(ast.NodeVisitor):
    ...
    def _add_finding(self, node: ast.Call, pattern_type: str, pattern_info: dict, func_name: str) -> None:
    ...
    try:
        ...
        findings.append(
            Finding(
                ...
                severity="low",
                type="bandit_error",
                description=f"Bandit scan failed: {e!s}",
                confidence=0.5,
                tool="stage2_static",
            )
        )
    ...
    try:
        ...
        findings.append(
            Finding(
                ...
                severity="low",
                type="analysis_error",
                description=f"Could not analyze Python file: {e!s}",
                location=file_path,
                confidence=0.5,
                tool="stage2_static",
            )
    ...
    try:
        ...
        findings.append(
            Finding(
                ...
                severity="low",
                type="analysis_error",
                description=f"Could not analyze JS file: {e!s}",
                location=file_path,
                confidence=0.5,
                tool="stage2_static",
            )
    ...
    try:
        ...
        findings.append(
            Finding(
                ...
                severity="low",
                type="analysis_error",
                description=f"Could not analyze shell file: {e!s}",
                location=file_path,
                confidence=0.5,
                tool="stage2_static",
            )
