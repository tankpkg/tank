...
@pytest.mark.skip(reason="Tests written for removed LLM-based endpoint; permissions now uses static analysis")
...
@pytest.mark.skip(reason="Tests written for removed LLM-based endpoint; security now uses 6-stage pipeline")
class TestSecurity:
...
@pytest.mark.skip(reason="Tests written for removed LLM-based endpoint; _lib module no longer exists")
class TestParseJson:
