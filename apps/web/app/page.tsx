...
export default async function Home() {
  ...
  const homepageJsonLdString = JSON.stringify(homepageJsonLd);

  return (
    <div className="min-h-screen bg-background tank-gradient-bg tank-grid-overlay">
      <Script id="homepage-json-ld" type="application/ld+json" strategy="beforeInteractive">
        {homepageJsonLdString}
      </Script>
