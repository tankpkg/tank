...
function main(): void {
  ...
  if (results.webRoutes.length > 0) {
    ...
    console.log(
      `${
        padRight('Route', 40) + padRight('Resp', 12) + padRight('FCP', 12) + padRight('LCP', 12) + padRight('CLS', 10)
      }Status`
    );
  ...
  if (results.apiRoutes.length > 0) {
    ...
    console.log(`${padRight('Route', 50) + padRight('p95', 12) + padRight('Samples', 10)}Status`);
