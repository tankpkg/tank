...
**Single source of truth:** `Implemented: apps/registry/src/api/routes/v1/badge.ts`.
...
```
# Implemented: apps/registry/src/api/routes/v1/badge.ts  # GET — returns SVG badge with trust level
```
