...
- `Implemented: apps/registry/src/api/routes/v1/whoami.ts` — server-side identity endpoint
...
# Implemented: apps/registry/src/api/routes/v1/whoami.ts  # GET — returns user info for valid token
```
