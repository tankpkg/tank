...
- `Implemented: apps/registry/src/api/routes/v1/scan.ts` — proxy to Python scanner
...
# Implemented: apps/registry/src/api/routes/v1/scan.ts  # POST — receives tarball, delegates to scanner service
