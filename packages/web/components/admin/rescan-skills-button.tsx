...
export function RescanSkillsButton() {
  ...
  async function handleRescan() {
    ...
    const confirmed = confirm('This will rescan all published skills. This may take several minutes. Continue?');
  ...
  return (
    <div className="space-y-3">
      <Button onClick={handleRescan} disabled={isScanning} variant="outline">
