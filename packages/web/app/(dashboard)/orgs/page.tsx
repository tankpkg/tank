...
export default function OrgsPage() {
  ...
  return (
    <div className="space-y-6">
        ...
        <Dialog open={createOpen} onOpenChange={handleDialogChange}>
          ...
          <DialogContent>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleCreate} disabled={creating || !orgName.trim() || !orgSlug.trim()}>
      ...
      {loading ? (
        <div className="text-muted-foreground text-sm py-8 text-center">Loading organizations...</div>
      ) : orgs.length === 0 ? (
