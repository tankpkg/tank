...
export default function OrgDetailPage() {
  ...
  if (loading) {
    return <div className="text-muted-foreground text-sm py-8 text-center">Loading organization...</div>;
  }
        ...
        <Dialog
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Invite a user to join this organization by their email address.</DialogDescription>
            </DialogHeader>
