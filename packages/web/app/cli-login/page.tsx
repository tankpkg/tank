  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <p style={styles.text}>The Tank CLI is requesting access to your account.</p>
        <div style={styles.userInfo}>
          <p style={styles.userText}>
            Signed in as <strong>{session.user.name || session.user.email}</strong>
          </p>
          {session.user.email && session.user.name && <p style={styles.emailText}>{session.user.email}</p>}
        </div>
