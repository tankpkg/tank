...
export const metadata: Metadata = {
  ...
  description:
    'Complete guide to using Tank: discover, install, and publish AI agent skills securely. Learn CLI commands, security features, and best practices.',
        ...
        <section className="tank-hero-gradient relative overflow-hidden">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight">Tank User Flow</h1>

              <p className="mt-3 text-lg text-emerald-400 font-medium">Everything You Need to Know</p>

              <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
                A security-first package manager for AI agent skills. Learn how to discover, install, and publish skills
                safely.
              </p>
                ...
                <CardContent className="text-sm">
                  <ul className="space-y-2">
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        <strong className="text-red-400">341 malicious skills</strong> discovered (12% of a marketplace)
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-red-500/20 text-xs font-bold text-red-400">
                      ...
                      <span>
                        Skills run with <strong>FULL agent authority</strong> (read files, API calls, shell commands)
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-red-500/20 text-xs font-bold text-red-400">
            ...
            <div className="mx-auto max-w-5xl">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <SecurityLayer
                  ...
                  benefits={['Path traversal prevention', 'Symlink attack protection', 'Target directory confinement']}
                />
              </div>
            </div>
          </div>
...
function CommandRow({ cmd, desc }: { cmd: string; desc: string }) {
  return (
    <div className="flex items-center justify-between gap-2 text-sm">
      <code className="text-xs bg-emerald-500/10 text-emerald-400 px-2 py-0.5 rounded font-mono">{cmd}</code>
    ...
    <Card className="overflow-hidden tank-card bg-card/50">
      ...
      <CardContent className="p-0">
        <div className="tank-terminal tank-scanlines">
          <pre className="overflow-x-auto p-3 text-xs text-emerald-400 font-mono">{command}</pre>
        </div>
      </CardContent>
    </Card>
  );
