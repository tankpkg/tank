  ...
  return (
    <div className="max-w-4xl mx-auto py-16 text-center">
      ...
      <p className="text-muted-foreground">
        <code className="rounded bg-muted px-2 py-1 text-sm font-mono">{name}</code> doesn&apos;t exist or hasn&apos;t
        been published yet.
      </p>
    </div>
  );
...
function _VersionHistory({ versions }: { versions: SkillVersionSummary[] }) {
    ...
    return (
      <div className="max-w-4xl mx-auto py-16 text-center">
        ...
        <p className="text-muted-foreground">
          ...
          <code className="rounded bg-muted px-2 py-1 text-sm font-mono">{skillName}</code>.
        </p>
        <p className="text-sm text-muted-foreground mt-4">{error instanceof Error ? error.message : "Unknown error"}</p>
      </div>
    );
  }
                ...
                {data.latestVersion && (
                  <>
                    ...
                    <div className="flex justify-between">
                      ...
                      <dd>
                        {data.latestVersion.tokenCount != null
                          ? formatTokenCount(data.latestVersion.tokenCount)
                          : "\u2014"}
                      </dd>
                    </div>
                    <div className="flex justify-between">
