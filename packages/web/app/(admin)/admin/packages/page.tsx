      ...
      <div className="space-y-4">
        <form method="get" className="flex flex-wrap gap-3 items-end">
          <div className="w-full sm:w-64">
            ...
            <Input id="search" name="search" placeholder="Package name" defaultValue={search} />
          </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex gap-2">
            {currentPage > 1 ? (
              <Button variant="outline" asChild>
                <Link href={`/admin/packages?${buildQuery(searchParams, currentPage - 1)}`}>Previous</Link>
              </Button>
            ) : (
            ...
            {currentPage < totalPages ? (
              <Button asChild>
                <Link href={`/admin/packages?${buildQuery(searchParams, currentPage + 1)}`}>Next</Link>
              </Button>
            ) : (
    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Search, filter, and moderate published packages.</p>
        </div>
        <RescanSkillsButton />
      </div>
