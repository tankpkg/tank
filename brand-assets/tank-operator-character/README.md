# Tank Operator Character Package
...
- `raw/` — generated source views and poses
- `sheets/turnaround.png` — front, 3/4, side, back
- `sheets/expressions.png` — neutral, happy, sad, angry, surprised, fearful
