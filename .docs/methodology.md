...
- `Web → apps/web/**/__tests__/ + apps/web/lib/__tests__/`
- `Shared → packages/internals-schemas/src/__tests__/ + packages/internals-helpers/src/__tests__/`
- `MCP → packages/mcp-server/__tests__/`
- `Scanner → apps/python-api/tests/ + scanner-local test_*.py`
